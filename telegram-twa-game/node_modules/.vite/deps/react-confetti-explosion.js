...
} from "./chunk-JG5OZRNJ.js";
import {
  require_prop_types
} from "./chunk-SY2YTOQZ.js";
import {
  require_jsx_runtime
} from "./chunk-HYULIDE6.js";
import {
  require_react_dom
} from "./chunk-3DMM3EQE.js";
import {
  require_react
} from "./chunk-5DWFEQXI.js";
import {
  __commonJS,
  __toESM,
  _global,
...
// node_modules/react-jss/node_modules/@babel/runtime/helpers/esm/extends.js
init_shim();
function _extends() {
...
// node_modules/react-jss/node_modules/@babel/runtime/helpers/esm/objectWithoutPropertiesLoose.js
init_shim();
    ...
    _proto.getTheme = function getTheme(outerTheme) {
      if (this.props.theme !== this.lastTheme || outerTheme !== this.lastOuterTheme || !this.cachedTheme) {
        ...
        if (typeof this.lastTheme === "function") {
          ...
          import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(isObject(this.cachedTheme), "[ThemeProvider] Please return an object from your theme function") : void 0;
        } else {
          var _theme = this.props.theme;
          import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(isObject(_theme), "[ThemeProvider] Please make your theme prop a plain object") : void 0;
  ...
  return function hoc(Component) {
    var withTheme2 = import_react.default.forwardRef(function(props, ref) {
      return import_react.default.createElement(context.Consumer, null, function(theme) {
        import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(isObject(theme), "[theming] Please use withTheme only with the ThemeProvider") : void 0;
...
function createUseTheme(context) {
  var useTheme2 = function useTheme3() {
    ...
    import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(isObject(theme), "[theming] Please use useTheme only with the ThemeProvider") : void 0;
    return theme;
  };
  return useTheme2;
}
...
function createRule(name, decl, options) {
  ...
  if (rule)
    return rule;
  if (name[0] === "@") {
    import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, "[JSS] Unknown rule " + name) : void 0;
  }
  return null;
}
...
var BaseStyleRule = function() {
  ...
  _proto.prop = function prop(name, value, options) {
    ...
    if (sheet && sheet.attached) {
      import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, '[JSS] Rule is not linked. Missing sheet option "link: true".') : void 0;
    }
    return this;
  };
...
var KeyframesRule = function() {
  function KeyframesRule2(key, frames, options) {
    ...
    if (nameMatch && nameMatch[1]) {
      ...
      this.name = "noname";
      import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, "[JSS] Bad keyframes name " + key) : void 0;
    }
...
var findReferencedKeyframe = function findReferencedKeyframe2(val, keyframes) {
  if (typeof val === "string") {
    return val.replace(refRegExp, function(match, name) {
      ...
      import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, '[JSS] Referenced keyframes rule "' + name + '" is not defined.') : void 0;
      return match;
    });
  }
  return val;
    ...
    this.registry = [].concat(this.plugins.external, this.plugins.internal).reduce(function(registry, plugin) {
      for (var name in plugin) {
        if (name in registry) {
          ...
          import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, '[JSS] Unknown hook "' + name + '".') : void 0;
        }
      }
      return registry;
    }, {
...
var createGenerateId = function createGenerateId2(options) {
  ...
  var generateId = function generateId2(rule, sheet) {
    ...
    if (ruleCounter > maxRules) {
      import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, "[JSS] You might have a memory leak. Rule counter is at " + ruleCounter + ".") : void 0;
    }
    var jssId = "";
    var prefix2 = "";
    if (sheet) {
...
var removeProperty = function removeProperty2(cssRule, prop) {
  try {
    ...
    import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, '[JSS] DOMException "' + err.message + '" was thrown. Tried to remove property "' + prop + '".') : void 0;
  }
};
...
function findPrevNode(options) {
  ...
  if (insertionPoint && typeof insertionPoint === "string") {
    ...
    import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, '[JSS] Insertion point "' + insertionPoint + '" not found.') : void 0;
  }
  return false;
}
function insertStyle(style, options) {
  ...
  if (insertionPoint && typeof insertionPoint.nodeType === "number") {
    ...
    if (parentNode)
      ...
      import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, "[JSS] Insertion point is not in the DOM.") : void 0;
    return;
  }
...
var _insertRule = function insertRule(container, rule, index4) {
  try {
    ...
    import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, "[JSS] " + err.message) : void 0;
    return false;
  }
        ...
        if (import_process.default.env.NODE_ENV === "development") {
          for (var prop in styleRule.style) {
            if (typeof styleRule.style[prop] === "function") {
              import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, "[JSS] Function values inside function rules are not supported.") : void 0;
              break;
            }
          }
        }
...
var parse = function parse2(cssText) {
  ...
  for (var i = 0; i < split.length; i++) {
    ...
    if (colonIndex === -1) {
      import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, '[JSS] Malformed CSS string "' + decl + '"') : void 0;
      continue;
    }
...
var GlobalPrefixedRule = function() {
  function GlobalPrefixedRule2(key, style, options) {
    ...
    this.rule = options.jss.createRule(selector, style, _extends4({}, options, {
      parent: this
    }));
  }
...
function handlePrefixedGlobalRule(rule, sheet) {
  ...
  for (var prop in style) {
    ...
    sheet.addRule(selector, style[prop], _extends4({}, options, {
      selector
    }));
    delete style[prop];
  }
...
// node_modules/jss-plugin-extend/node_modules/@babel/runtime/helpers/esm/extends.js
init_shim();
function _extends5() {
...
function mergeExtend(style, rule, sheet, newStyle) {
  ...
  if (extendType === "string") {
    ...
    if (!refRule)
      return;
    if (refRule === rule) {
      import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, "[JSS] A rule tries to extend itself \n" + rule.toString()) : void 0;
      return;
    }
  ...
  if (Array.isArray(style.extend)) {
    for (var index4 = 0; index4 < style.extend.length; index4++) {
      ...
      var singleStyle = typeof singleExtend === "string" ? _extends5({}, style, {
        extend: singleExtend
      }) : style.extend[index4];
...
function jssNested() {
  function getReplaceRef(container, sheet) {
    return function(match, key) {
      ...
      import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, '[JSS] Could not find the referenced rule "' + key + '" in "' + (container.options.meta || container.toString()) + '".') : void 0;
      return key;
    };
  }
    ...
    for (var prop in style) {
      ...
      if (isNested) {
        ...
        if ("replaceRule" in container) {
          container.replaceRule(name, style[prop], _extends6({}, options, {
            selector
          }));
        } else {
          container.addRule(name, style[prop], _extends6({}, options, {
            selector
          }));
        }
...
function registerClass(rule, className) {
  ...
  if (className[0] === "$") {
    ...
    if (!refRule) {
      import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, "[JSS] Referenced rule is not defined. \n" + rule.toString()) : void 0;
      return false;
    }
    if (refRule === rule) {
      import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, "[JSS] Cyclic composition detected. \n" + rule.toString()) : void 0;
      return false;
    }
...
function supportedProperty17(prop, options) {
  ...
  if (!el)
    return prop;
  if (import_process.default.env.NODE_ENV !== "benchmark" && cache2[prop] != null) {
    return cache2[prop];
  }
...
function supportedValue(property, value) {
  ...
  if (import_process.default.env.NODE_ENV !== "benchmark" && cache$1[cacheKey] != null) {
...
var getStyles = function getStyles2(options) {
  ...
  import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(styles.length !== 0, "[JSS] <" + (options.name || "Hook") + ` />'s styles function doesn't rely on the "theme" argument. We recommend declaring styles as an object instead.`) : void 0;
